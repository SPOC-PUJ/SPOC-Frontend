...
onMounted(() => {
  ...
  const resetZoomButton = d3
      ...
      .append('button')
      .html(`<i class="pi pi-search-minus mr-2"></i>Restablecer Zoom`)
      .attr('class', 'flex items-center px-4 py-2 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75')
